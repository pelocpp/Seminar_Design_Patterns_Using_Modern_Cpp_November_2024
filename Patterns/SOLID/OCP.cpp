...
namespace SecondConceptualExampleOCP {
    ...
    public:
        ...
        GenericAndSpecification(const TArgs& ... args) // parameter pack // ... einpacken
        {
            m_vec = { args ... };   // auspacken ...  // std::initializer_list
        }
...
static void test_conceptual_example_ocp_01()
{
    ...
    auto filteredProducts = productFilter.filter(products, greenSpecification);
