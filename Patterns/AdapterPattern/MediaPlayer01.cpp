...
void test_media_player_01()
{
    ...
    std::shared_ptr<IMediaPlayer> audioPlayer1{   // Typ:  IMediaPlayer
        std::make_shared<AudioPlayer>()           // AudioPlayer*  // Heap
    };

    clientCode(audioPlayer1);
    std::cout << std::endl;

    std::shared_ptr<IMediaPlayer> audioPlayer2{   // Typ:  IMediaPlayer
        std::make_shared<AudioPlayerExtended>()   // AudioPlayerExtended*  // Heap
    };
